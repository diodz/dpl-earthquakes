...
### Existing open issue (already present before this pass)

- **#26** Reviewer 1 Comment 3.3: SCM estimator robustness (SDID and bias-correction)
...
| 2.2 Comparability and spatial heterogeneity (apples-to-oranges risk) | Unaddressed/partial | [#29](https://github.com/diodz/dpl-earthquakes/issues/29) |
...
| 3.4 SUTVA/spillovers | Addressed (spillover diagnostics + geographic exclusions) | [#33](https://github.com/diodz/dpl-earthquakes/issues/33) |
...
| Reviewer comment | Status | Issue |
|---|---|---|
| Major 1: SUTVA/inter-regional spillovers (O'Higgins/Auckland contamination risk) | Addressed (spillover diagnostics + geographic exclusions) | [#33](https://github.com/diodz/dpl-earthquakes/issues/33) |
...
- Pre-existing relevant open issue kept as-is: **#26**.
