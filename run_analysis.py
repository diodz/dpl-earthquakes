...
Runs:
  ...
  2. Maule SCM.ipynb - generates maule_*, chile_jacknife figures
  3. Canterbury SCM.ipynb - generates nz_*, nz_scm_Construction, nz_scm_Other_Sectors
...
def main():
    ...
    # 2. Execute notebooks (nbconvert --execute runs from notebook's directory)
