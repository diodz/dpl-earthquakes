...
\begin{itemize}
  \item \textbf{Canterbury}: construction share gap \(+2.53\) p.p. (pseudo-\(p=0.00\)); non-construction share gap \(-2.13\) p.p. (pseudo-\(p=0.00\)); non-construction \emph{level} gap \(+911.23\) (\(+3.53\%\) of synthetic; pseudo-\(p=0.87\)).
