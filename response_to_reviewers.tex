...
(iii) Third, we have added a small footnote (see footnote 13 on page 36) at the beginning of the institutional discussion reiterating that the contrasts documented in Appendix E constitute descriptive correlates rather than formally identified causal mechanisms.
...
\paragraph{Response.} We thank the reviewer for this suggestion. To the best of our ability, and given the length constraints of this revised version of the paper, we have added a new Appendix~E, Section~E.4, which analyzes the indicators of Table 4 [now Table~7 in the revised paper] along with the disaster-specific institutional evidence documented in the appendix's chronology and quantitative contrast tables (Tables~E.14--E.16). This section also addresses the reviewer's specific example directly, by discussing whether differences in government debt capacity might have constrained Chile's reconstruction response. Finally, and following also the reviewer's previous suggestion, we retain the characterization of these indicators as contextual descriptors rather than SCM inputs, since they are national-level scores that cannot be decomposed to the regional level and were not randomly assigned across cases. However, we do believe that the new Appendix E underscores that there are several informative descriptors that align with the observable institutional contrasts documented in the disaster-specific evidence.
