...
Canterbury's per-capita gap survives the decomposition: total GDP rises above synthetic and population remains below synthetic, so the per-capita effect reflects both a stronger numerator and a smaller denominator. For Maule, the GDP-per-capita decomposition over the observed sub-window remains null-like; however, because population/total-GDP series do not cover the full SCM horizon, we cannot fully adjudicate denominator effects for the full window.
