...
\paragraph{Response.}
Agreed, and we have adjusted the framing accordingly. In the revised manuscript, Table~7 (formerly Table~4) is treated explicitly as contextual, national-level descriptors rather than SCM inputs, and we now state clearly that sub-national institutional-quality measures are not available in a comparable form for Maule and Canterbury. To improve transparency, we added Appendix~E, which documents disaster-specific institutional evidence (chronology, quantitative contrasts, and regulatory milestones) and links it to the interpretation while maintaining the same non-causal caveat.
