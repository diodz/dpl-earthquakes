...
First, we now make the identification boundary explicit at the start of Section~5 and in the corresponding footnote: our SCM design identifies the aggregate divergence in outcomes, but does not causally isolate any single institutional channel (including insurance liquidity) without micro-level  and more micro-level granular data.
