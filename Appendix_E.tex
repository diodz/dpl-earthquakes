...
Days 1--7} &
State of Catastrophe declared in Maule and Biob{\'{\i}}o (Feb~28). Military curfew imposed. Approx.\ 14,000 troops deployed (CRS Report R41112). ONEMI coordinated initial response; later criticized for tsunami warning failures. &
...
EQC appointed Fletcher Construction to project-manage residential repairs (approx.\ 50,000 homes). Assessment teams deployed. Small claims (under-cap) assessed within months (Khakurel et al., 2021). Private insurers processing in parallel. \\
\addlinespace
...
{Year 2} &
Centralized ministerial direction continued. No significant regulatory changes. Community participation limited (C{\'a}rdenas-Jir{\'o}n, 2012). By Oct~2012: 54\% housing complete; 30\% under construction (Platt, 2019). &
...
{Years 3--5} &
Spending continued through central transfers. No comparable construction sector surge relative to counterfactual (Section~4.3). &
...
\vspace{2pt}
{\scriptsize \textit{Table~\ref{tab:chronology} concluded. Sources:} Chile: ECLAC (2010); Platt (2019); Comerio (2013); CRS Report R41112. New Zealand: DPMC/CERA; NZ Auditor-General (2017); Canterbury Earthquake Recovery Act 2011; ICNZ; EQC Annual Reports; Grube \& Storr (2018); Te Ara.}
\end{table}
...
n/a &
$>$NZ\$5 billion (NHC, 2024) \\

Median settlement time (EQC) &
No comparable public data &
Small: 138--191\,d; Med: 712--890\,d; Large: 1,226--1,392\,d \\
...
Substantial (volunteers, entrepreneurs) \\

\bottomrule
\end{tabular}

\vspace{4pt}
{\scriptsize \textit{Table~\ref{tab:quantcontrasts} concluded.} \textbf{Notes:} Insurance penetration (Chile): AIR Worldwide (2010); Nguyen \& Noy (2020) cite $<$20\%. NZ: near-universal; ${\sim}$80\% insured. Reinsurance (NZ): NHC (2024) reports $>$\$5bn. CERA spent NZ\$4bn/5~yrs (Auditor-General, 2017). Red Zone: 8,062 properties (Te Ara). Social capital: Dussaillant \& Guzm{\'a}n (2014), \textit{Disasters} 38(4):808--832; no regional panel for either country. Settlement times: Khakurel et al.\ (2021, NZSEE). Over-cap transfers ${\sim}$2/day through mid-2018 (ICNZ).}
\end{table}
...
\vspace{2pt}
{\scriptsize \textit{Table~\ref{tab:regmilestones} concluded. Sources:} Chile: MINVU (2010, 2011); Comerio (2013); Platt (2019). NZ: DPMC/CERA; Canterbury EQ Recovery Act 2011; NZ Auditor-General (2013, 2017); IRP/preventionweb.}
\end{table}
...
To conclude, in interpreting Table~7 alongside the disaster-specific evidence in Tables~\ref{tab:chronology} to \ref{tab:regmilestones} reinforces the core interpretive point of Section~5: the divergent recovery trajectories are most consistently explained not by differential fiscal capacity (which actually favored Chile, at 11\% vs.\ 63\% debt-to-GDP) nor by broad macroeconomic stability, but by the pre-existing institutional architecture for disaster-specific financial mobilization, regulatory adaptation, and coordinated implementation. Chile's superior fiscal position did not translate into a comparable output response because the institutional channel through which spending was deployed (i.e., centralized ministerial programs without a dedicated recovery authority, or insurance-based external capital) was slower and less regionally targeted. The six-month lag to the Plan de Reconstrucci{\'o}n, the absence of regulatory override powers, and the limited community co-production all contrast with New Zealand's 35-day CERA establishment, over 60 Orders in Council adapting legislation, and the SCIRT public--private alliance. 

% ============================================================
% ADDITIONAL SOURCES
% ============================================================
\subsection*{ Sources for Appendix~E}
\addcontentsline{toc}{subsection}{Additional Sources for Appendix E}

The following sources were consulted for this appendix:

\begin{enumerate}
\item Natural Hazards Commission Toka T{\=u} Ake (2024). ``Natural Disaster Fund.'' \url{https://www.eqc.govt.nz/what-we-do/natural-disaster-fund/}. Accessed 26~Feb 2026.

\item Office of the Auditor-General, NZ (2017). ``Canterbury Earthquake Recovery Authority: Assessing its Effectiveness and Efficiency.'' \url{https://oag.parliament.nz/2017/cera/}.

\item Comerio, M.\,C. (2013). ``Housing Recovery in Chile.'' PEER Report 2013/01, UC Berkeley.

\item Wilson, J. (2016). ``Canterbury Earthquakes and Rebuild.'' Te Ara Encyclopedia of NZ. \url{https://teara.govt.nz/en/canterbury-region/page-17}.

\item Congressional Research Service (2010). ``Chile Earthquake: U.S.\ and International Response.'' CRS Report R41112.

\item Khakurel, S., Dhakal, R.\,P., Yeow, T.\,Z., and Saha, S. (2021). ``Residential Building Repair Cost and Claim Settlement Time from the Canterbury Earthquake Sequence.'' Paper~157, NZSEE Conference 2021. Data from EQC CES claims database.

\item Insurance Council of New Zealand (ICNZ) (2024). ``Canterbury Earthquakes.'' \url{https://www.icnz.org.nz/industry/canterbury-earthquakes/}. Total insured cost (NZ\$31bn), private insurer claims ($>$168,000), over-cap transfer timelines.
\end{enumerate}
