"""
Generate map figures for the article: Maule (Chile) and Canterbury (NZ).

Replaces notebooks/create_maps.py. Outputs are written to article_assets/ (used by main.tex).
"""
import os
...
def plot_country_highlight(world, country_col, region_col,
    ...
    if also_pdf:
        ...
        print(f"Saved: {out_path} and {base}.pdf")
    else:
