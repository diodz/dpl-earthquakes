...
\paragraph{In-Time Placebo (Falsification) Test:} We run a falsification (in-time placebo) test by pretending the disaster happened earlier than it did (e.g., a placebo quake in 2006 for Maule). We find no significant divergence in this test, as expected. The full set of rolling in-time placebos is shown in Appendix~\ref{app:intime}.\\
...
\appendix
\section{Denominator Effect: Population and Total GDP}
\label{app:denominator}
A concern with GDP per capita is that an apparent gain could reflect out-migration (shrinking denominator) rather than rising output. To rule this out, we ran SCM with \textit{Population} and \textit{Total Regional GDP} as outcomes. Figure~\ref{fig:denom} shows that both population and total GDP paths for Maule and Canterbury track their synthetic counterfactuals closely; there is no significant divergence in either the numerator or the denominator. This supports our interpretation that the Canterbury GDP per capita gain reflects genuine output increase.

\begin{figure}[H]\centering
\caption{\textbf{Population and Total GDP: Treated vs.\ Synthetic (Denominator Check)}}
\label{fig:denom}
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/maule_pop_paths.png}\\
\caption{Maule: Population}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/nz_pop_paths.png}\\
\caption{Canterbury: Population}
\end{subfigure}\\[1ex]
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/maule_gdp_total_paths.png}\\
\caption{Maule: Total GDP}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/nz_gdp_total_paths.png}\\
\caption{Canterbury: Total GDP}
\end{subfigure}
\end{figure}

\section{In-Time Placebo Tests}
\label{app:intime}
We implement rolling in-time placebos by assigning fake treatment years to each pre-treatment year. Figure~\ref{fig:intime} shows the treated unit's gap (2010 for Maule, 2011 for Canterbury) against the distribution of in-time placebo gaps. The true treatment year produces a uniquely extreme gap; all placebos remain within the pack.

\begin{figure}[H]\centering
\caption{\textbf{In-Time Placebo: Treated Gap vs.\ Fake Treatment Years}}
\label{fig:intime}
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/maule_in_time_placebos.png}\\
\caption{Maule}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/nz_in_time_placebos.png}\\
\caption{Canterbury}
\end{subfigure}
\end{figure}

\section{Maule Sectoral SCM}
\label{app:maule_sector}
Figure~\ref{fig:maule_sector} presents SCM applied to the Construction share and Other\_Sectors share of GDP for Maule. Both series track their synthetic counterfactuals closely after 2010, consistent with the aggregate null effect.

\begin{figure}[H]\centering
\caption{\textbf{SCM Applied to Sectoral Shares (Maule)}}
\label{fig:maule_sector}
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/maule_scm_Construction.png}\\
\caption{Construction share}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/maule_scm_Other_Sectors.png}\\
\caption{Other sectors share}
\end{subfigure}
\end{figure}

\section{Construction Share Placebo Test}
\label{app:construction_placebo}
Figure~\ref{fig:construction_placebo} shows the placebo distribution for the construction share of GDP in Canterbury. The treated unit's gap is clearly outside the distribution of placebo gaps, confirming statistical significance of the construction surge.

\begin{figure}[H]\centering
\caption{\textbf{Placebo Test: Canterbury Construction Share}}
\label{fig:construction_placebo}
\includegraphics[width=0.7\textwidth]{article_assets/nz_scm_Construction_placebos.png}
\end{figure}

\section{Treatment Timing Sensitivity (Canterbury 2010)}
\label{app:t2010}
Using 2010 as the first post-treatment year (Darfield quake) instead of 2011 yields similar results. Figure~\ref{fig:t2010} shows the GDP per capita path when treatment starts in 2010; the positive gap persists and conclusions are unchanged.

\begin{figure}[H]\centering
\caption{\textbf{Canterbury: Treatment Year 2010 Sensitivity}}
\label{fig:t2010}
\includegraphics[width=0.7\textwidth]{article_assets/nz_gdp_paths_t2010.png}
\end{figure}
