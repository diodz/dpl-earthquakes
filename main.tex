...
For interpretability of the Y/L outcome in both cases, we apply the same decomposition to Maule: we re-estimate SCM on total regional GDP and population using the same donor pool and pre-treatment design as the baseline Maule analysis. Figure~\ref{fig:maule_decomposition_paths} and Figure~\ref{fig:maule_decomposition_gaps} show that Maule's gaps remain near zero for all three outcomes (GDP per capita, total GDP, and population). Thus the null result is not an artifact of migration or denominator composition; it holds for both the level of output and the population denominator.
...
\begin{figure}[H]\centering
\caption{\textbf{Maule Outcome Decomposition: Treated vs Synthetic Paths}}
\label{fig:maule_decomposition_paths}
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/chile_maule_total_gdp_paths.png}
\caption{Total GDP Path}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/chile_maule_population_paths.png}
\caption{Population Path}
\end{subfigure}
\begin{minipage}{0.95\textwidth}\footnotesize\vspace{1ex}
\textit{Notes:} Same SCM configuration as baseline Maule analysis (donor pool, predictors, pre-treatment window); only the dependent variable changes.
\end{minipage}
\end{figure}

\begin{figure}[H]\centering
\caption{\textbf{Maule Outcome Decomposition: Gap (Treated $-$ Synthetic) in \%}}
\label{fig:maule_decomposition_gaps}
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/chile_maule_total_gdp_gap.png}
\caption{Total GDP Gap}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/chile_maule_population_gap.png}
\caption{Population Gap}
\end{subfigure}
\end{figure}
