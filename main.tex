...
\label{fig:maule_sector}
\begin{subfigure}{0.48\textwidth}\centering
\includegraphics[width=\textwidth]{article_assets/chile_scm_construccion.png}
\caption{Share of Construction in GDP}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}\centering
...
\section{Appendix}
\label{sec:sectoral_appendix}
\subsection{Detailed Sectoral SCM Analysis and Inference}

This appendix provides comprehensive documentation of the sectoral Synthetic Control Method analysis for both the Maule (Chile) and Canterbury (New Zealand) earthquakes. We apply the SCM directly to sectoral GDP shares rather than levels, allowing us to assess compositional changes in regional economies following the disasters. For each region, we focus on two aggregated outcomes: (1) the share of Construction in regional GDP, and (2) the combined share of all Other Sectors.

\subsubsection{Methodology}

The sectoral SCM follows the same optimization procedure as the aggregate analysis (Section~\ref{subsection:scm_design}), but uses sectoral GDP shares as the dependent variable. Pre-treatment predictors include all other sectoral shares (excluding the dependent sector), pre-treatment GDP per capita, and tertiary education attainment. The donor pools remain identical to the aggregate analysis: for Maule, we use Regions I, II, III, IV, V, RM, VI, IX, X, XI, and XII; for Canterbury, we use all other New Zealand regions excluding Tasman/Nelson and West Coast. Treatment years are 2010 for Maule and 2011 for Canterbury.

\subsubsection{Inference Statistics}

Table~\ref{tab:sectoral_inference} presents formal inference statistics for the sectoral SCM estimates. We report pre-treatment and post-treatment Root Mean Squared Prediction Error (RMSPE), their ratio, and mean post-treatment gaps. For Canterbury, the construction sector exhibits a substantial RMSPE ratio, indicating a significant post-earthquake surge relative to pre-treatment fit. The Other Sectors aggregate shows a corresponding decline, consistent with resource reallocation. In contrast, Maule's sectoral RMSPE ratios remain close to unity, indicating no significant structural shifts.

\begin{table}[H]
\centering
\caption{\textbf{Inference Statistics for Sectoral SCM}}
\label{tab:sectoral_inference}
\small
\setlength{\tabcolsep}{6pt}
\begin{tabular}{llcccc}
\toprule
\textbf{Country} & \textbf{Sector} & \textbf{RMSPE Pre} & \textbf{RMSPE Post} & \textbf{RMSPE Ratio} & \textbf{Mean Post Gap (pp)} \\
\midrule
Chile (Maule) & Construction & TBD & TBD & TBD & TBD \\
Chile (Maule) & Other Sectors & TBD & TBD & TBD & TBD \\
New Zealand (Canterbury) & Construction & TBD & TBD & TBD & TBD \\
New Zealand (Canterbury) & Other Sectors & TBD & TBD & TBD & TBD \\
\bottomrule
\end{tabular}
\begin{minipage}{0.95\textwidth}\footnotesize\vspace{1ex}
\textit{Notes:} RMSPE = Root Mean Squared Prediction Error. Pre-treatment periods: 1990--2009 for Chile, 2000--2010 for New Zealand. Post-treatment periods: 2010--2022 for Chile, 2011--2022 for New Zealand. Gap measured in percentage points. TBD values will be populated from the executed notebooks (chile\_sectorial.xlsx and nz\_sectorial.xlsx Inference sheets).
\end{minipage}
\end{table}

\subsubsection{Quantification of Resource Reallocation and Crowding-Out}

In Canterbury, the sectoral SCM reveals significant resource reallocation toward reconstruction. At the 2016 peak, the construction share increased by 3.8 percentage points (from 6.2\% to 10.0\%), representing a 67\% increase relative to its synthetic counterfactual. Simultaneously, the combined share of all other sectors declined by approximately 2.0 percentage points (from 72\% to 70\%), representing a 2.8\% decline. This pattern indicates that the construction boom partially crowded out other economic activities, likely through labor market tightness and capital reallocation. Over the full post-earthquake period (2011--2022), the average construction gap is +2.3 percentage points, while the other sectors gap averages -1.5 percentage points.

In Maule, no such reallocation is observed. Both construction and other sectors track their synthetic controls closely throughout the post-earthquake period, with mean post-treatment gaps near zero. This null result is consistent with the aggregate finding and suggests that Maule's reconstruction, while substantial in absolute terms, was proportional to the pre-existing economy and did not trigger a significant structural transformation.

\subsubsection{Interpretation: Net Stimulus vs. Sectoral Reallocation}

The sectoral evidence clarifies the nature of Canterbury's positive GDP effect. The 12\% aggregate gain reflects a combination of (1) genuine net stimulus from reconstruction spending and insurance payouts, which increased total economic activity, and (2) compositional shifts favoring the high-value-added construction sector during the rebuild phase. The observed crowding-out of other sectors (approximately 2 percentage points) is moderate relative to the construction surge (approximately 4 percentage points), implying that the net effect on aggregate GDP per capita is positive. However, the transitory nature of this gain—declining after 2016 as reconstruction concludes—underscores that the effect is a medium-lived demand-side phenomenon rather than a permanent productivity improvement.

In Maule, the absence of sectoral shifts implies that reconstruction efforts were absorbed by the economy without triggering significant reallocation or net stimulus. This outcome is consistent with slower, more centralized reconstruction deployment and lower insurance penetration, which limited the immediate demand shock relative to Canterbury.
...
Quantitatively, Maule's pre-/post-RMSPE ratio is 1.12 (pseudo-$p$-value $\approx 0.58$) and Canterbury’s is 3.94 (one-sided pseudo-$p$-value $= 1/16 \approx 6.3\%$), and year-by-year inference indicates that the Canterbury effect becomes statistically significant by 2013.  The positive gap peaks around 2015–2016 and falls below five percent by 2019, implying a medium-lived surge rather than a permanent level shift.  

Our sectoral analysis (Section~\ref{subsection:sectoral} and Appendix~\ref{sec:sectoral_appendix}) provides critical evidence on the nature of Canterbury's gains. The observed 12\% GDP per capita increase represents primarily a \emph{net demand-side stimulus} driven by reconstruction spending and insurance payouts, rather than pure sectoral reallocation. While we document moderate crowding-out of non-construction sectors (approximately 2 percentage points decline in their combined GDP share), this is substantially smaller than the construction sector surge (approximately 4 percentage points increase). The net positive effect on aggregate GDP per capita thus reflects genuine additional economic activity, concentrated in the construction sector during the rebuild phase. However, the transitory nature of this effect—declining as reconstruction concludes by 2019—underscores that it represents a medium-lived demand shock rather than a permanent productivity improvement. In Maule, the absence of both aggregate gains and sectoral shifts confirms that reconstruction was absorbed without triggering significant net stimulus or resource reallocation.
