...
Quantitatively, Maule's pre-/post-RMSPE ratio is 1.12 (pseudo-$p$ value $\approx 0.58$) and Canterbury's is 3.94 (one-sided pseudo-$p$ value $= 1/16 \approx 6.3\%$). The positive Canterbury gap peaks around 2015--2016 and falls below five percent by 2019, consistent with a medium-lived level overshoot rather than a permanent shift. Our findings underscore that \emph{institutions matter} in disaster recovery: Canterbury's post-quake boom was facilitated by strong formal and informal institutions, while Chile's institutions appear to have supported recovery back to trend without overshoot. Notably, this divergence occurs despite the treated regions being of broadly comparable relative size within their countries.
