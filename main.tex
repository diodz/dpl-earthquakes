...
\midrule
Chile & Treated (Maule)      & 0.82 & 0.62 & $-0.20$ \\
Chile & Adjacent (O'Higgins, Araucanía, Biobío) & 0.84 & 0.63 & $-0.21$ \\
Chile & Non-adjacent (9 regions) & 1.02 & 0.75 & $-0.28$ \\
\midrule
...
Table~\ref{tab:sector_spillover_diagnostics} examines whether the construction boom in treated regions spilled into neighbouring regions via labour reallocation. For Canterbury, the treated region's construction share rose substantially (+2.3 p.p.), but adjacent regions show no comparable shift ($-0.1$ p.p.), and the non-adjacent group experienced a modest decline ($-0.2$ p.p.). For Maule, neither the treated nor adjacent regions show large construction-share changes. This evidence does not support a claim that reconstruction-driven labour demand in the treated region systematically drew resources from neighbouring donor regions.
...
\midrule
Chile & Treated (Maule)      & 7.46 & 8.29 & $+0.83$ \\
Chile & Adjacent  & 8.53 & 8.78 & $+0.25$ \\
Chile & Non-adjacent & 8.90 & 8.65 & $-0.25$ \\
\midrule
...
\end{tabular}
\begin{minipage}{0.95\textwidth}\footnotesize\vspace{1ex}
\textit{Notes:} Construction share is the sectoral share of regional GDP averaged over 5-year pre- and post-treatment windows.
\end{minipage}
\end{table}
